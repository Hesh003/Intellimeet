...
const MeetingSchema = new mongoose_1.Schema({
    ...
    lecturerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
    availabilityId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Availability', required: true },
